...
Design notes and paper-linked documentation will live here.

- `probe_templates.md` describes probe template usage and schema guidance.
- `metrics.md` summarizes metrics fields and schema notes.
- `probe_response_schema.md` documents the probe response schema.
- `event_schema.md` documents the event log schema.
- `run_manifest_schema.md` documents the run manifest schema.
- `event_types.md` lists core event types.
